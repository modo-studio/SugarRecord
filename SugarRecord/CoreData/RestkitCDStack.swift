...
public class RestkitCDStack: DefaultCDStack
{
    override public func initialize() {
        //let store: RKManagedObjectStore = RKManagedObjectStore(self.managedObjectModel)
        //store.addSQLitePersistentStoreAtPath(databasePath!, fromSeedDatabasePath:nil, withConfiguration: nil, options: nil, error: &error)
