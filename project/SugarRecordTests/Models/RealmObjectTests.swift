...
class RealmObjectTests: XCTestCase
{
    ...
    func testObjectQuerying()
    {
        ...
        XCTAssertEqual(RealmObject.by(key: "age", equalTo: "22").find()!.count, 2, "It should return 2 elements with the age of 22")
        XCTAssertEqual(RealmObject.by(key: "age", equalTo: "10").find()!.count, 0, "It should return 0 elements with the age of 10")
