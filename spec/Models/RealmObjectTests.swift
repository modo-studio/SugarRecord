...
class RealmObjectTests: XCTestCase
{
    ...
    func testObjectQuerying()
    {
        ...
        XCTAssertEqual(RealmObject.sorted(by: "name", ascending: true).first().find().firstObject().name, "Realmy", "The name of the first object returned should be Realmy")
        XCTAssertEqual(RealmObject.sorted(by: "name", ascending: true).last().find().firstObject().name, "Realmy2", "The name of the first object returned should be Realmy2")
