...
//    */
//    class func by(predicate: NSPredicate) -> SugarRecordFinder<SugarRecordObjectProtocol>
//    
//    /**
//    *  Returns a SugarRecord finder passing a predicate in String format
//    */
//    class func by(predicateString: NSString) -> SugarRecordFinder<SugarRecordObjectProtocol>
//    
//    /**
//    *  Returns a SugarRecord finder passing a predicate in a value-key format
//    */
//    class func by(key: String, equalTo value: String) -> SugarRecordFinder<SugarRecordObjectProtocol>
//    
//    
//    //MARK: - Sorting
//    
...
//    */
//    class func sorted(by sorterKey: String, ascending: Bool) -> SugarRecordFinder<SugarRecordObjectProtocol>
//    
//    /**
//    *  Returns a SugarRecord finder pasing a sort descriptor
//    */
//    class func sorted(by sortDescriptor: NSSortDescriptor) -> SugarRecordFinder<SugarRecordObjectProtocol>
//    
//    /**
//    *  Returns a SugarRecord finder passing a sort descriptor
//    */
//    class func sorted(by sortDescriptors: [NSSortDescriptor]) -> SugarRecordFinder<SugarRecordObjectProtocol>
//    
//    
//    //MARK: - All
//    
...
//    */
//    class func all() -> SugarRecordFinder<SugarRecordObjectProtocol>
//    
//    
//    //MARK: - Deletion
//    
